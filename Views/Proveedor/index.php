...
<main>
    ...
    <div class="toolbar">
        <a href="?c=Proveedor&a=crud" class="btn-arcade btn-primary">+ NUEVO PROVEEDOR</a>
                ...
                <?php else: ?>
                    ...
                    <tr>
                        <td class="text-center font-mono">
                            #<?php echo str_pad($r->id_proveedor, 3, "0", STR_PAD_LEFT); ?>
                        </td>
                        ...
                        <td class="text-center">
                            <div class="flex-center">
                                <a href="?c=Proveedor&a=crud&id=<?php echo $r->id_proveedor; ?>" class="btn-small btn-edit">EDITAR</a>

                                <a href="?c=Proveedor&a=eliminar&id=<?php echo $r->id_proveedor; ?>" 
                                   onclick="return confirm('Vas a eliminar al proveedor #<?php echo str_pad($r->id_proveedor, 3, "0", STR_PAD_LEFT); ?>. ¿Seguro?');" 
